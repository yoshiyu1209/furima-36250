  ...
  describe '商品購入' do
    ...
    context '商品購入できないとき' do
      ...
      it 'phone_numberが空では購入できない' do
        ...
        @item_order.valid?
        expect(@item_order.errors.full_messages).to include('電話番号を入力してください', '電話番号が短いです', '電話番号は半角数字で入力してください')
      end
      it 'phone_numberにハイフンがあると購入できない' do
        @item_order.phone_number = '080-8888-8888'
        @item_order.valid?
        expect(@item_order.errors.full_messages).to include('電話番号が短いです', '電話番号は半角数字で入力してください')
      end
      ...
      it 'phone_numberが9桁では購入できない' do
        ...
        @item_order.valid?
        expect(@item_order.errors.full_messages).to include('電話番号が短いです')
      end
